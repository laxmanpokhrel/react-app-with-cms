...
const MediaGrid = (props) => {
    ...
    const onClose = () => {
        ...
        dispatch(drawerActions.resetContent());
    }
    return (
        <>
            <List
                ...
                renderItem={(item) => (
                    <List.Item
                        ...
                        onClick={() => {
                            ...
                            dispatch(drawerActions.addContent(item))
                        }}
                        bordered={true}
                    >{
            ...
            />
            <DrawerElement onClose={onClose} visible={drawerVisible} />
        </>)
};
